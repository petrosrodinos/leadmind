...
export function ContactsTable({ contacts, isLoading, isFetching, page, pageSize, total, totalPages, onPageChange, onRowClick, selectedKeys, onSelectionChange }: ContactsTableProps) {
