...
import { CheckCircle2, CircleDashed, Clock, Send, Sparkles, XCircle, AlertTriangle } from "lucide-react";
...
> = {
  ...
  DRAFTS_READY: { label: "Drafts Ready", color: "success", icon: Sparkles },
...
export function CampaignStatusBadge({ status }: { status: CampaignStatuses }) {
